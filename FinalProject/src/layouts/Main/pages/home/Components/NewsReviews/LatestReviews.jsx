  ...
  return (
    <>
      <div className="col-md-6">
        <div className="porto-testimonial">
          <h2 className="section-title">
            <span className="inline-title">Latest Reviews</span>
          </h2>
              ...
              <div className="testimonial">
                <div className="testimonial-author">
                  <div className="thumbnail-author">
                    <img
                      src="https://cdn.shopify.com/s/files/1/1613/0131/files/client-1-12_150x150.png?v=1600590123"
                      alt=""
                    />
                  </div>
                  <p>
                ...
                <blockquote>
                  ...
                  >
                    ...
                    >
                      <g
                        id="Artboard-Copy"
                        transform="translate(-407.000000, -9.000000)"
                      >
                        <path
                  ...
                  Hello, I want to thank you for creating a great template and
                  for the excellent and quick support and help that you have
                  been providing to me as I begin to work with it.
                </blockquote>
              </div>
            </div>
          </div>
