...
export default function ShopProduct({ product, brandData }) {
            ...
            <div className="product-image">
              ...
              >
                ...
                <div className="image-holder">
                  <img src={product?.images[0].url} alt="" className="first" />
                  <img src={product?.images[1].url} alt="" className="second" />
                </div>
              </Link>
